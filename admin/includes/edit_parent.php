                ...
                <!-- ADD PARENT MODAL -->
                  ...
                  <div class="row">
                    <div class="col-md-2 pr-md-1">
                      <div class="form-group">
                      <label>User Id <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="Unique ID for user"></i></label>
                        <input type="text" class="form-control" placeholder="Username" name="user_id" value="<?php echo $user_id; ?>" readonly>
                      </div>
                    </div>
                    <div class="col-md-2 pr-md-1">
                      <div class="form-group">
                      <label>Parent Id <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="ID used to match with respective kids"></i></label>
                        <input type="text" class="form-control" placeholder="Username" name="parent_id" value="<?php echo $parent_id; ?>" readonly>
                      </div>
                    </div>
                    <div class="col-md-2 pr-md-1">
                      <div class="form-group">
