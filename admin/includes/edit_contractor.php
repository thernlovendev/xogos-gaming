...
if(isset($_GET['edit_contractor'])) {
    ...
    $the_user_id = $_GET['edit_contractor'];
...
if(isset($_POST['edit_contractor'])) {
              ...
              <div class="card-body">
                <!-- ADD PARENT MODAL -->
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        <label>Company</label>
                        <input type="text" class="form-control" placeholder="Company Name" name="company" value="<?php echo $company; ?>" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <h5 class="mb-4 pb-2 pb-md-0 mb-md-5">Login Information</h5>
                    ...
                    <input type="submit" class="btn btn-primary" name="edit_contractor" value="Update Profile">
                </form>
              </div>
            </div>
          </div>
