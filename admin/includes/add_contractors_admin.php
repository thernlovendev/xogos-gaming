...
$zip       = mysqli_real_escape_string($connection, $zip);
    ...
    $query  = "INSERT INTO users(company, firstname, lastname, email, username, password, address, city, state, zip, contractor_id, user_role, token) ";
    $query .= "VALUES('{$company}', '{$firstname}', '{$lastname}', '{$email}', '{$username}', '{$password}', '{$address}', '{$city}', '{$state}', '{$zip}', RAND()*(999-1)+5, 'contractor', '{$token}'  ) ";
...
<!-- Modal -->
<div class="modal fade" id="exampleModalCenterContractor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
